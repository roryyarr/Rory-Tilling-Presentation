...
\begin{frame}{Hilbert 18th problem}
    In 1902 David Hilbert posed 23 problems for mathemiticians to 
\end{frame}

\begin{frame}{Wang tiles}
    In 1962 Hao Wang conjectured the following set of tiles can only tile the plane aperiodically.
    \begin{figure}
        \centering
        \includegraphics[width=0.5\linewidth]{images/other-tiles/Wang_11_tiles.svg.png}
...
\begin{frame}{Robinson Tiles}
    In 1971 Raphael Robinson from Berkeley show the following 6 tiles only aperiodically.
    \begin{figure}
        \centering
...
\begin{frame}{Penrose Tilling}
    \begin{figure}
        \centering
        \includegraphics[width=0.5\linewidth]{images/penrose/Penrose_Tiling_(Rhombi).svg}
        \caption{Rhombic Penrose tilling \cite{penrose_tiling_rhombi}}
